...
# ── Load data ──────────────────────────────────────────────────────────
df = pd.read_parquet("BGLS2019_rep/replication/output/descriptive.parquet")
...
fig.tight_layout()
fig.savefig("BGLS2019_rep/replication/output/Figure3.png", dpi=150)
plt.close(fig)

print("Saved BGLS2019_rep/replication/output/Figure3.png")
